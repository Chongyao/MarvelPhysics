...
FEM_TEMP
size_t FEM_CLASS::Nx() const{return all_dim_;}
...
template class
finite_element<double, 3, 3, 4, 1, 1, linear_csttt, basis_func, quadrature>;

template class
finite_element<double, 3, 3, 8, 1, 2, linear_csttt, basis_func, quadrature>;

template class
finite_element<double, 3, 3, 4, 1, 1, stvk, basis_func, quadrature>;
template class
