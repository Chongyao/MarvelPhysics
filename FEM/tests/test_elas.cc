...
using TET_ELAS = BaseElas<FLOAT_TYPE, 3, 4, 1, 1, arap_csttt, basis_func, quadrature>;
int main(int argc, char** argv){
  ...
  newton_iter<FLOAT_TYPE, 3> imp_euler(dat_str, energy, dt, 20, 1e-4, true, false, false);
