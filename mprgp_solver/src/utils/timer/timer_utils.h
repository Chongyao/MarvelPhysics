...
namespace chaos
{
  namespace utils
  {
     ...
     */
    void STW_RESET (const std::string &token, timer_scale_t scale = TS_MILLISECONDS);
     ...
     * @param scale : new scale.
     */
    void STW_RESET (const stopwatch_id_t &id, timer_scale_t scale = TS_MILLISECONDS);
     ...
     * @param scale : new scale.
     */
    void STW_RESET_START (const std::string &token, timer_scale_t scale = TS_MILLISECONDS);
     ...
     * @param scale : new scale
     */
    void STW_RESET_START (const stopwatch_id_t &id, timer_scale_t scale = TS_MILLISECONDS);
