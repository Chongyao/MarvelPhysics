...
// #pragma omp parallel for
  ...
  collision COLL(simulation_para.get<double>("w_coll"),'z', simulation_para.get<double>("g_pos"), nods.cols(), dim);
  ...
  for(size_t i = 0; i < max_iter; ++i){
    ...
    COLL.Gra(nods.data(), displace.data(), dat_str, PS.get_Mass_VectorXd());
