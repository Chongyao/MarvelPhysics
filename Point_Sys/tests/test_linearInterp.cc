...
#pragma parallel omp for
  ...
  //construct deform_surf_LI
  MatrixXi four_NN = SH.get_four_noncoplanar_NN(nods);
  deform_surf_LI<double> DS(surf, nods, points, four_NN);
  cout << "ds init finished" << endl;
...
#pragma parallel omp for
    ...
    vet_displace = DS.update_surf(displace);
    acce = new_acce;
