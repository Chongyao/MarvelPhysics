...
typedef boost::property_Eigen::Map<Graph, boost::vertex_index_t>::type IndexMap;
typedef boost::property_Eigen::Map<Graph, boost::vertex_name_t>::type NameMap;
typedef boost::iterator_property_Eigen::Map<Vertex*, IndexMap, Vertex, Vertex&> PredecessorMap;
typedef boost::iterator_property_Eigen::Map<Weight*, IndexMap, Weight, Weight&> DistanceMap;
