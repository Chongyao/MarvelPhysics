...
{
 public:
  PETsc_CG_imp(const double *val, const int_type *idx,  const int_type *ptr,
    ...
    if(sizeof(int_type) == sizeof(int)) {
      ...
      zjucad::matrix::itr_matrix<const int_type*> ptr_m(col, 1, ptr);
      zjucad::matrix::itr_matrix<const int_type*> idx_m(nnz, 1, idx);
      ptr_ = ptr_m;
      idx_ = idx_m;
      MatCreateSeqAIJWithArrays(
          comm,
